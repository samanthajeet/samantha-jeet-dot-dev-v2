    ...
    <main>
      ...
      <div className="my-8 flex h-14 w-full flex-row space-x-2 overflow-x-auto">
        <div className="flex items-center justify-between rounded border border-neutral-200 bg-neutral-50 px-3 py-4 dark:border-neutral-700 dark:bg-neutral-800">
          <a href="https://www.linkedin.com/in/samanthajeet/">
            <svg width="35" height="27" role="img" aria-label="LinkedIn logo">
        ...
        <div className="flex items-center justify-between rounded border border-neutral-200 bg-neutral-50 px-3 py-4 dark:border-neutral-700 dark:bg-neutral-800">
          <a href="https://github.com/samanthajeet">
            <svg width="35" height="27" role="img" aria-label="GitHub Logo">
        ...
        <div className="flex items-center justify-between rounded border border-neutral-200 bg-neutral-50 px-3 py-4 dark:border-neutral-700 dark:bg-neutral-800">
          <a href="https://instagram.com/samjeet">
            <svg width="35" height="27" role="img" aria-label="Instagram Logo">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
